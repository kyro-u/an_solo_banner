...
lib.ssMetadata = [
		{name:"banner_solo_atlas_1", frames: [[0,62,373,47],[0,0,468,60],[375,62,72,48],[0,111,213,25],[449,62,56,56]]}
];
...
(lib.CachedBmp_2 = function() {
	this.initialize(ss["banner_solo_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.solo_logo_notextorsquare = function() {
	this.initialize(ss["banner_solo_atlas_1"]);
	this.gotoAndStop(4);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.solo_logo_notextorsquare();
...
// stage content:
(lib.banner_solo = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// production
	this.instance = new lib.production("synched",0);
	this.instance.setTransform(731.3,44);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(48).to({_off:false},0).to({x:252.3,y:42},11).wait(1));

	// kyro_gaming
	this.instance_1 = new lib.gaming("synched",0);
	this.instance_1.setTransform(663.5,20.5);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(33).to({_off:false},0).to({x:184.5,y:18.5},15).wait(12));

	// logo
	this.instance_2 = new lib.logo("synched",0);
	this.instance_2.setTransform(511,32);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},0).to({x:32,y:30},15).wait(31));
...
p.nominalBounds = new cjs.Rectangle(234,30,590.6,30);
// library properties:
lib.properties = {
	id: 'EC4ADB1E50B14C9C97BF2220EABE77FA',
	width: 468,
	height: 60,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/banner_solo_atlas_1.png?1619457128327", id:"banner_solo_atlas_1"}
	],
	preloads: []
};
...
an.compositions['EC4ADB1E50B14C9C97BF2220EABE77FA'] = {
